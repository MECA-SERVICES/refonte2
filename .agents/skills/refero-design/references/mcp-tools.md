...
| Parameter         | Type     | Required | Notes                                                                                                                                   |
| ----------------- | -------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| `style_id`        | string   | Yes*     | Style UUID from `refero_search_styles`. _Exactly one of `style_id` or `style_ids` must be provided._                                    |
| `style_ids`       | string[] | Yes*     | Array of style UUIDs. Full styles are large; recommended max batch is 3-4. _Exactly one of `style_id` or `style_ids` must be provided._ |
